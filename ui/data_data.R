tagList(
  ...
  column(
    ...
    strong(textOutput("tit_ind")),
    htmlOutput("def_ind"),
    br(),
    h4("Scenario Details:"),
    strong(textOutput("tit_scen")),
    htmlOutput("def_scen"),
    br(),
    htmlOutput("df_warn"),
    h4("Access Data:"),
    downloadButton('data_dl', 'Download'),
    checkboxInput('isono', 'Include ISO Country Codes', FALSE)
  ),
  tags$script(
    "$('#linkToSelect').click(function() {
  ...
  tags$head(
    tags$style(".table .alignRight {text-align:right; InfoThousands}")
  )
)
